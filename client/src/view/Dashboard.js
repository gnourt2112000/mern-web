...
const Dashboard = () => {
    ...
    if(postsLoading){
            ...
            <>
                <Card className='text-center mx-5 my-5'>
                    ...
                    <Card.Body>
                        ...
                        <Button variant='primary'onClick={setShowAddPostModal.bind(this,true)}>Watch now</Button>
                    </Card.Body>
                </Card>
            </>
        )
        ...
        body = (
            <>
                <Row className='mx-auto mt-3 row-cols-1 row-cols-md-3'>
                ...
                <OverlayTrigger placement='left' overlay={<Tooltip >Add a new thing to watch</Tooltip>}>
