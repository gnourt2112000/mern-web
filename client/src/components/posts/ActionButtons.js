...
const ActionButtons = ({url,_id}) => {
    ...
    return (
        <>
            ...
            <Button className='post-button' onClick={choosePost.bind(this,_id)} target='_blank'>
                <img src={editIcon} alt="edit" width='24' height='24'></img>    
            </Button> 
            <Button className='post-button' onClick={deletePost.bind(this,_id)} target='_blank'>
